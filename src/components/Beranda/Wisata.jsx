...
const Wisata = () => {
  ...
  return (
    <section id='wisata' className='my-20'>
        <div className='container'>
            <div className='grid grid-cols-1 gap-0 md:grid-cols-8 lg:grid-cols-12 md:gap-8'>
                ...
                <div className='col-span-1 mt-4 md:col-span-5 lg:col-span-8 md:mt-0' data-aos='fade-left' data-aos-duration='2000'>
                    <Swiper className='flex flex-row mySwiper' modules={[Pagination, Autoplay]} loop={true} autoplay={{delay: 2500, disableOnInteraction: false,}} slidesPerView={2} spaceBetween={20}>
                        <SwiperSlide>
                            <div>
                                <img className="w-full -z-10" src={wisataImage1} alt="hero-image" />
                                <div className='absolute z-50 p-4 bottom-2 lg:bottom-6 lg:p-6'>
